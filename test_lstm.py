# this file is used to test the LSTM prediction accuray
# The accuracy is tested on the videos that were from the same person doing the steps
...
p1_array = np.load(data_location+'pose_1/pose_1_test.npy')
p2_array = np.load(data_location+'pose_2/pose_2_test.npy')
...
p1_y = np.zeros((4,),dtype = int)
p2_y = np.ones((4,),dtype = int)
